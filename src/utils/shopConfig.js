/** Shop contact, hours, and deposit rules (keep in sync with server/utils/shopConfig.js). */

export const DEPOSIT_PERCENT = 0.8;
...
export function calcDepositRequired(totalCost) {
